...
<head>
    ...
    <title>Booking Gedung Pernikahan</title>
...
<header>
    <div class="container">
        <h1 class="text-center">Booking Gedung Pernikahan</h1>
...
<main>
    <div class="container">
        <div class="gedung-info">
            <h2>Pernikahan</h2>
            <img src="asset/gambar/gedung_pernikahan.jpg" alt="Gedung Pernikahan">
            ...
            <form action="proses_booking.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="rincian_harga" name="rincian_harga" value="Harga sewa Rp 6.150.000" readonly>
                </div>
