...
// Get pricing for Rapat/Meeting (ID: 2)
$event_pricing = getPriceByEventId($pdo, 2);
$event_price = $event_pricing ? $event_pricing['formatted_price'] : 'Rp 3.885.000';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $stmt = $pdo->prepare("SELECT COUNT(*) FROM pemesanan WHERE id_acara = 2 AND 
...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-6 left-section">
                <h1 class="event-title">RAPAT</h1>
                <img src="asset/gambar/gedung_rapat.jpg" alt="Gedung Rapat" class="event-image">
                
                <div class="event-details">
                    <strong>Harga Sewa <?= $event_price ?>;</strong>
                    <p>Kapasitas : 20 Orang.</p>
                    <p>Lokasi : Jl. Jenderal Sudirman No. 1, Pemalang.</p>
                    <p>Fasilitas : Panggung Utama, Halaman Parkir, Meja, Kursi, Luas, AC, Toilet.</p>
    ...
    <script>
        // Price per day for rapat
        const pricePerDay = <?= $event_pricing ? $event_pricing['price'] : 3885000 ?>;
        ...
        function pesanSekarang() {
            ...
            setTimeout(() => {
                const url = `proses_sewa.php?acara=rapat&tanggal_mulai=${encodeURIComponent(startDate)}&tanggal_selesai=${encodeURIComponent(endDate)}`;
