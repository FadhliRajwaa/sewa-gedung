<?php
/**
 * Fungsi reorder yang lebih sederhana tanpa transaksi kompleks
 * Khusus untuk mengatasi error "There is no active transaction"
 */

require_once 'config.php';

/**
 * Mengatur ulang ID penyewa agar berurutan (versi sederhana)
 */
...
/**
 * Mengatur ulang ID pemesanan agar berurutan (versi sederhana)
 */
function simpleReorderPemesananIds() {
    global $pdo;
    try {
        // Ambil semua data pemesanan dengan urutan berdasarkan tanggal_pesan (chronological order)
        $stmt = $pdo->query("SELECT * FROM pemesanan ORDER BY tanggal_pesan ASC, id_pemesanan ASC");
...
/**
 * Mengatur ulang ID pembayaran agar berurutan (versi sederhana)
 */
function simpleReorderPembayaranIds() {
    global $pdo;
    try {
