...
$tanggal_selesai_param = isset($_GET['tanggal_selesai']) ? $_GET['tanggal_selesai'] : '';
        ...
        }_param = isset($_GET['tanggal_mulai']) ? $_GET['tanggal_mulai'] : '';
$tanggal_selesai_param = isset($_GET['tanggal_selesai']) ? $_GET['tanggal_selesai'] : '';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // Get metode pembayaran from form
        ...
        // Insert booking
        $stmt = $pdo->prepare("
            INSERT INTO pemesanan (id_penyewa, id_acara, tanggal_sewa, tanggal_selesai, durasi, total, metode_pembayaran, tanggal_pesan, tipe_pesanan, status) 
