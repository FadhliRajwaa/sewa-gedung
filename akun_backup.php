        ...
        <div class="form-container">
            ...
            <form method="POST">
                <div class="form-group">
                    ...
                    <input type="text" name="nama_lengkap" class="form-control" value="<?= htmlspecialchars($penyewa['nama_lengkap'] ?? '') ?>" required>
                </div>
                <div class="form-group">
                    <label>No. Telepon</label>
                    <input type="text" name="no_telepon" class="form-control" value="<?= htmlspecialchars($penyewa['no_telepon'] ?? '') ?>">
                </div>
                <div class="form-group">
                    <label>Alamat</label>
                    <textarea name="alamat" class="form-control" rows="3"><?= htmlspecialchars($penyewa['alamat'] ?? '') ?></textarea>
                </div>
                <div class="form-group">
...
<footer class="footer">
    <p>&copy; <?= date('Y') ?> PT. Aneka Usaha Perseroda</p>
</footer>
</body>
</html>
