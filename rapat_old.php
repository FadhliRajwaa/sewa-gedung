...
<head>
    ...
    <title>Booking Gedung Rapat</title>
...
<header>
    <div class="container">
        <h1 class="text-center">Booking Gedung Rapat</h1>
...
<main>
    <div class="container">
        <div class="gedung-info">
            <h2>Rapat</h2>
            <img src="asset/gambar/gedung_rapat.jpg" alt="Gedung Rapat">
            ...
            <form action="proses_booking.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="rincian_harga" name="rincian_harga" value="Harga sewa Rp 3.850.000" readonly>
                </div>
