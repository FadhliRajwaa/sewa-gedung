...
<body>
    <div class="container">
        ...
        <div class="main-content">
            ...
            <div class="page-header">
                <h1><i class="fas fa-chart-bar"></i> Laporan Penyewaan</h1>
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <div class="stat-label">Dari Semua Transaksi</div>
                </div>
                <div class="stat-card">
                ...
                <div class="stat-card">
                    <h3>Bulan Ini</h3>
                    <div class="stat-value" id="bulanIni">Rp 0</div>
                    <div class="stat-label">Pendapatan</div>
                </div>
                <div class="stat-card">
                    <h3>Gedung Populer</h3>
                    <div class="stat-value" id="gedungPopuler" style="font-size: 18px;">-</div>
                    <div class="stat-label">Paling Sering Disewa</div>
                </div>
            </div>
            ...
            <div class="table-container">
                <div class="table-header">
                    <h2>Detail Laporan Penyewaan</h2>
                </div>
    ...
    <script>
        ...
        function updateStats(data) {
            document.getElementById('totalPendapatan').textContent = 'Rp ' + (parseInt(data.total_revenue || 0)).toLocaleString('id-ID');
            document.getElementById('totalTransaksi').textContent = data.total_transactions || 0;
            document.getElementById('bulanIni').textContent = 'Rp ' + (parseInt(data.avg_daily || 0)).toLocaleString('id-ID');
            document.getElementById('gedungPopuler').textContent = data.popular_venue || '-';
        }
        ...
        function updateChart(data) {
            ...
            data.forEach(item => {
                if (item.tanggal_acara && item.status_pembayaran === 'Lunas') {
                    ...
                    monthlyData[monthKey] += parseInt(item.total_biaya || 0);
                }
            });
        ...
        function filterData() {
            ...
            if (status) {
                filteredData = filteredData.filter(item => {
                    return (item.status_pembayaran || '').toLowerCase() === status.toLowerCase();
                });
            }
